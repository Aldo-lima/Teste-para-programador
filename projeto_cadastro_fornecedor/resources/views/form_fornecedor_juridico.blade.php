      ...
      <div id="form-pessoa" style="background-color: #ffff; padding:10px; margin:20px;" id="form_pess_fisica">
          <div classe="row" id="form-pessoa">
            <div class="form-check form-check-inline">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio"  onclick="location.href='{{route('fornecedorFisica.create')}}'"   name="tipo" id="inlineRadio2" value="option2" required>
              ...
              <div id="form_endereco" style="background-color: #ffff; padding:10px; margin:20px; ">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="text" name="cep" value=""onblur="pesquisacep(this.value);" class="form-control" id="cep" data-js="cep"> required>
                            </div>
                            <div class="col-4">
